...
const CoinDetails = () => {
  ...
  const numStyle = currency === "inr" ? "en-IN" : "en";
        ...
        <>
          ...
          <VStack spacing={"4"} p="16" alignItems={"flex-start"}>
            ...
            <Stat>
              ...
              <StatNumber>
                {currencySymbol}
                {coin.market_data.current_price[currency].toLocaleString({numStyle}, {
                  useGrouping: true,
                })}
              </StatNumber>
              <StatHelpText>
            ...
            <Box w={"full"} p="4">
              <Item
                title={"Max Supply"}
                value={coin.market_data.max_supply.toLocaleString({numStyle}, {
                  useGrouping: true,
                })}
              />
              <Item
              ...
              <Item
                ...
                value={`${currencySymbol}${coin.market_data.market_cap[
                  currency
                ].toLocaleString({numStyle}, { useGrouping: true })}`}
              />
              <Item
                title={"All Time Low"}
